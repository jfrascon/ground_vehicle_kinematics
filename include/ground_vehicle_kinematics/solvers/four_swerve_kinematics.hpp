...
namespace ground_vehicle_kinematics
{
  ...
  class FourSwerveKinematicsSolver
  {
     ...
     * @throws std::invalid_argument If the wheel states are inconsistent with the configured wheels.
     */
     ...
     * @param wheel_states Wheel states in documented wheel order.
     * @throws std::invalid_argument If the input wheel states are inconsistent with the stored wheel descriptors.
     */
