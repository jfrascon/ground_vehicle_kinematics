...
\begin{itemize}
    ...
    \item \(v_{i\perp}\): la componente de la velocidad perpendicular a la dirección de rodadura (eje \(\ejeYWi\); i.e, la dirección de su eje de rotación).
\end{itemize}
...
\begin{itemize}
    \item Calcular el vector \(\mathbf{b} = [{}^{\frameBOne}V_{1,x}, {}^{\frameBOne}V_{1,y}, \ldots, {}^{\frameBN}V_{N,x}, {}^{\frameBN}V_{N,y}]^{\trans}\).\\
          Donde:
          \begin{equation}
              \begin{aligned}
              ...
              \end{aligned}
          \end{equation}
    \item Resolver el sistema lineal \(A\mathbf{x} = \mathbf{b}\) mediante la pseudoinversa de \(A\), \(A^+\), como se explicó en la Sección \ref{sec:general-considerations}, para obtener la velocidad del chasis \(\mathbf{x} = [{}^\frameR V_{r,x}, {}^\frameR V_{r,y}, \omega_{r,z}]^{\trans}\).
\end{itemize}
