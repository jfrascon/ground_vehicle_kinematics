...
\begin{itemize}
    ...
    \item Rueda frontal \((i = 0)\):
          \[
              \begin{aligned}
                  \alpha_0   & = 0                                \\
                  \vect{d}_0 & =(d\cos 0,\ d\sin 0) = (d, 0)      \\
                  \beta_0    & =\frac{\pi}{2} - 0 = \frac{\pi}{2}
              \end{aligned}
          \]
    \item Rueda izquierda \((i = 1)\):
          \[
              \begin{aligned}
                  \alpha_1   & = \alpha                     \\
                  \vect{d}_1 & = (d\cos\alpha, d\sin\alpha) \\
                  \beta_1    & = \frac{\pi}{2} - \alpha
              \end{aligned}
          \]
    \item Rueda derecha \((i = 2)\):
          \[
              \begin{aligned}
                  \alpha_2   & = -\alpha                                                        \\
                  \vect{d}_2 & = (d\cos(-\alpha), d\sin(-\alpha)) = (d\cos\alpha, -d\sin\alpha) \\
                  \beta_2    & = \frac{\pi}{2} - (-\alpha) = \frac{\pi}{2} + \alpha
              \end{aligned}
          \]
\end{itemize}
...
\begin{equation}
    \begin{aligned}
        A & = \begin{bmatrix}
              ...
              \end{bmatrix} = \begin{bmatrix}
                                  1 & 0 & -d\cos\left(\frac{\pi}{2}- 0\right)                  \\
                                  0 & 1 & \phantom{-}d\sin\left(\frac{\pi}{2} - 0\right)       \\
                                  1 & 0 & -d\cos\left(\frac{\pi}{2}-\alpha\right)              \\
                                  0 & 1 & \phantom{-}d\sin\left(\frac{\pi}{2}-\alpha\right)    \\
                                  1 & 0 & -d\cos\left(\frac{\pi}{2}-(-\alpha)\right)           \\
                                  0 & 1 & \phantom{-}d\sin\left(\frac{\pi}{2}-(-\alpha)\right)
                              \end{bmatrix}  = \\
          & = \begin{bmatrix}
...
\begin{itemize}
    ...
    \item Rueda trasera \((i = 0)\):
          \[
              \begin{aligned}
                  \alpha_0   & = \pi                                 \\
                  \vect{d}_0 & =(d\cos \pi,\ d\sin \pi) = (-d, 0)    \\
                  \beta_0    & =\frac{\pi}{2} - \pi = -\frac{\pi}{2}
              \end{aligned}
          \]
    \item Rueda izquierda \((i = 1)\):
          \[
...
\begin{equation}
    \begin{aligned}
        A & = \begin{bmatrix}
                  ...
                  \cos\phi_2 & \phantom{-}\sin\phi_2 & \phantom{-}d_2\sin\beta_2
              \end{bmatrix} = \begin{bmatrix}
                                  1 & 0 & -d\cos\left(\frac{\pi}{2} - \pi\right)                 \\
                                  0 & 1 & \phantom{-}d\sin\left(\frac{\pi}{2} - \pi\right)       \\
                                  1 & 0 & -d\cos\left(\frac{\pi}{2} - \alpha\right)              \\
                                  0 & 1 & \phantom{-}d\sin\left(\frac{\pi}{2} - \alpha\right)    \\
                                  1 & 0 & -d\cos\left(\frac{\pi}{2} - (-\alpha)\right)           \\
                                  0 & 1 & \phantom{-}d\sin\left(\frac{\pi}{2} - (-\alpha)\right)
